...
function Library:SetTheme(Theme)
    ...
    for _, v in next, ThemeInstances.Main do
        pcall(function()
    ...
    for _, v in next, ThemeInstances.MainTrue do
        pcall(function()
    ...
    for _, v in next, ThemeInstances.Secondary do
        pcall(function()
    ...
    for _, v in next, ThemeInstances.SecondaryTrue do
        pcall(function()
    ...
    for _, v in next, ThemeInstances.Tertiary do
        pcall(function()
    ...
    for _, v in next, ThemeInstances.TertiaryTrue do
        pcall(function()
    ...
    for _, v in next, ThemeInstances.Text do
        pcall(function()
            v.TextColor3 = ThemeColor.Text
        end)
    end

    for _, v in next, ThemeInstances.PlaceholderText do
        pcall(function()
            v.PlaceholderColor3 = ThemeColor.PlaceholderText
        end)
    end

    for _, v in next, ThemeInstances.Textbox do
        pcall(function()
    ...
    for _, v in next, ThemeInstances.NavBar do
        pcall(function()
    ...
    for _, v in next, ThemeInstances.Theme do
        pcall(function()
    ...
    for _, v in next, ThemeInstances.ThemeTrue do
        pcall(function()
...
function Library:Create(options)
    ...
    function Library:ResizeTabCanvas()
        ...
        for _, v in pairs(Gui["6"]:GetChildren()) do
        ...
        task.spawn(function()
            ...
            if options.KeySystem then
                ...
                task.spawn(function()
                    ...
                    for _, v in next, KeyConnectionBin do
                        v:Disconnect()
                    end
                end)
        ...
        function Tab:Section(options)
            ...
            function Section:Button(options)
                ...
                do
                    function Button:Destroy()
                        ...
                        for _, v in next, Button.Connections do
                            pcall(function()
                                v:Disconnect()
            ...
            function Section:Toggle(options)
                ...
                do
                    function Toggle:Destroy()
                        ...
                        local Disconnected = 0
                        for _, v in next, Toggle.Connections do
                            pcall(function()
                                v:Disconnect()
                                Disconnected = Disconnected + 1
                            end)
            ...
            function Section:Slider(options)
                ...
                do
                    ...
                    function Slider:Destroy()
                        ...
                        local Disconnected = 0
                        for _, v in next, Slider.Connections do
                            pcall(function()
                                v:Disconnect()
                                Disconnected = Disconnected + 1
                            end)
                ...
                do
                    ...
                    do
                        ...
                        function Keybind:Destroy()
                            ...
                            local Disconnected = 0
                            for _, v in next, Keybind.Connections do
                                pcall(function()
                                    v:Disconnect()
                                    Disconnected = Disconnected + 1
                                end)
            ...
            function Section:SmallTextbox(options)
                ...
                do
                    ...
                    function Textbox:Destroy()
                        ...
                        local Disconnected = 0
                        for _, v in next, Textbox.Connections do
                            pcall(function()
                                v:Disconnect()
                                Disconnected = Disconnected + 1
                            end)
            ...
            function Section:BigTextbox(options)
                ...
                do
                    ...
                    function BigTextbox:Destroy()
                        ...
                        local Disconnected = 0
                        for _, v in next, BigTextbox.Connections do
                            pcall(function()
                                v:Disconnect()
                                Disconnected = Disconnected + 1
                            end)
            ...
            function Section:Dropdown(options)
                    ...
                    table.insert(
                        ...
                        Dropdown["5e"]:GetPropertyChangedSignal("Text"):Connect(function()
                            if Dropdown["5e"].Text == "" then
                                for _, v in pairs(Dropdown["4b"]:GetChildren()) do
                                    if v:IsA("Frame") then
                                        v.Visible = true
                                    end
                                end
                ...
                function Dropdown:Destroy()
                    ...
                    local Disconnected = 0
                    for _, v in next, Dropdown.Connections do
                        pcall(function()
                            v:Disconnect()
                            Disconnected = Disconnected + 1
                        end)
            ...
            function Section:Label(options)
                ...
                do
                    ...
                    function Label:Destroy()
                        ...
                        local Disconnected = 0
                        for _, v in next, Label.Connections do
                            pcall(function()
                                v:Disconnect()
                                Disconnected = Disconnected + 1
                            end)
            ...
            function Section:Colorpicker(options)
                ...
                do
                    ...
                    function Colorpicker:Destroy()
                        ...
                        local Disconnected = 0
                        for _, v in next, Colorpicker.Connections do
                            pcall(function()
                                v:Disconnect()
                                Disconnected = Disconnected + 1
                            end)
...
function Library:Popup(options)
    ...
    do
        for _, text in next, options.Options do
            do
                local PromptOption = {}
...
function Library:Destroy()
    ...
    for _, v in next, ConnectionBin do
        pcall(function()
            v:Disconnect()
    ...
    for _, Controls in next, ControlsConnectionBin do
        for _, event in next, Controls do
